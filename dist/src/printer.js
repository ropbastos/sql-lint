...
class Printer {
    ...
    warnAboutUncategoriseableQuery(content, tokenised, prefix) {
    ...
    warnAboutNoStdinStream() {
        console.log(`sql-lint requires either a file, directory or stdin as an argument
